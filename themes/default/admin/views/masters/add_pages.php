    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("masters/add_pages", $attrib);
                ?>
                <div class="row">
                ...
                <div class="col-sm-12 last_sa_se"><?php echo form_submit('add_pages', lang('submit'), 'class="btn btn-primary change_btn_save center-block"'); ?></div>
